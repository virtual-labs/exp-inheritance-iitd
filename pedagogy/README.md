...
<b> Experiment|  <b> 1. Introduction to Inheritance
...
#### Experimentation
The lab will focus on the process of develop java programming code including the syntax and methods used for inherit one class into anoter class in java program.
#### Learn from failure
...
:--|:--|:--|:-:
1.| Student will be able to: <br>describe the structure of inheritance using java <br> | Understand| Describe
2.| Student will be able to: <br>identify different components of a java program<br> | Apply| Identify
3.| Student will be able to: <br>develop a basic java program to display value of any variable | Create| Develop
...
:--|:--|:--|:--
1.| Student will be able to structure of inheritance using java. | Select the text editor for your java program. | Q • What is subclass in java?<br><b>a) A subclass is a class that extends another class</b><br>b) A subclass is a class declared inside a class<br>c) Both above<br>d) None of the above
2.| Student will be able to identify different components of a java program.| Demonstrate the working of inheriting one class to another class. | Q • Inheritance relationship in Java language is <br>a) Association<br><b>b) Is-A</b><br>c) Has-A<br>d) None
3.| Student will be able to develop a basic java program to display value of any variable .| Construct a java program for displaying given output. | Q • Advantage of inheritance in java programming is/are<br>a) Code Re-usability<br>b) Class Extendibility<br>c) Save development time<br><b>d) All</b>
